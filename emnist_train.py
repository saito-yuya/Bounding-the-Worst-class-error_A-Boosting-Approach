...
from opts_emnist import parser
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if  args.arch == 'resnet18':
        ...
        torch.save(model.state_dict(),f'checkpoint/{args.store_name}/{args.dataset},{args.loss_type},{args.train_rule}.pt')
    ...
    if args.early_stop != None:
        ...
        earlystopping = EarlyStopping(patience=args.epochs, verbose=True, path = f'checkpoint/{args.store_name}/{args.dataset},{args.loss_type},{args.train_rule}.pt')
    ...
    if args.dataset == 'emnist':
        train_dataset = torchvision.datasets.EMNIST(root='./data', 
                                  transform=transform, download= False, split='byclass',train= True)
        ...
        test_dataset = torchvision.datasets.EMNIST(root='./data', 
                                  transform=transform, download= False, split='byclass',train=False)
    else:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.early_stop  != None:
            ...
            if earlystopping.early_stop or epoch == args.epochs - 1: 
                ...
                print("epoch :",epoch)
                model.load_state_dict(torch.load(f'checkpoint/{args.store_name}/{args.dataset},{args.loss_type},{args.train_rule}.pt'))  
